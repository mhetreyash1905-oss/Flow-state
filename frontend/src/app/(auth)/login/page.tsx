  ...
  return (
    <div className="w-full max-w-md bg-slate-900/60 border border-slate-850 p-8 rounded-2xl backdrop-blur-md shadow-2xl flex flex-col">
      ...
      <div className="flex flex-col items-center mb-8 text-center">
        ...
        <h1 className="font-extrabold text-2xl tracking-tight text-white mb-2">Welcome Back</h1>
        <p className="text-slate-400 text-xs tracking-wider uppercase font-semibold flex items-center gap-1.5 justify-center">
          ...
          <span>Consistency Monk</span>
        </p>
      </div>

      {/* Error Callout */}
      {error && (
        <div className="mb-6 bg-red-500/10 border border-red-500/20 text-red-400 text-xs px-4 py-3 rounded-lg font-medium">
          {error}
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="space-y-1.5">
          ...
          <input
            ...
            disabled={loading}
            className="w-full bg-slate-950/60 border border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-lg px-4 py-3 text-sm text-slate-100 placeholder-slate-500 transition-all outline-none"
          />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <input
              ...
              placeholder="••••••••"
              disabled={loading}
              className="w-full bg-slate-950/60 border border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-lg pl-4 pr-10 py-3 text-sm text-slate-100 placeholder-slate-500 transition-all outline-none"
            />
            <button
              type="button"
